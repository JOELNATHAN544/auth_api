...
import type { AxiosPromise, AxiosInstance, RawAxiosRequestConfig } from 'axios/index';
...
export const AuthApiFp = function(configuration?: Configuration) {
    ...
    return {
        ...
        async login(loginRequest: LoginRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<LoginResponse>> {
            ...
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios as unknown as AxiosInstance, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         * @param {RegisterRequest} registerRequest 
...
export const ProtectedApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        meRoute: async (options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const ProtectedApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async meRoute(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<User>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.meRoute(options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ProtectedApi.meRoute']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios as unknown as AxiosInstance, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
export const ProtectedApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        meRoute(options?: RawAxiosRequestConfig): AxiosPromise<User> {
            return localVarFp.meRoute(options).then((request) => request(axios, basePath));
        },
    };
};
...
export class ProtectedApi extends BaseAPI {
     ...
     * @memberof ProtectedApi
     */
    public meRoute(options?: RawAxiosRequestConfig) {
        return ProtectedApiFp(this.configuration).meRoute(options).then((request) => request(this.axios, this.basePath));
    }
}
